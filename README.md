...
## 版本说明
[![release](https://img.shields.io/badge/release-v1.0.4-orange.svg)](https://github.com/zhou-you/EasySegmentedBarView/blob/master/update.md)
...
```
dependencies {
 compile 'com.zhouyou:segmentedbar:1.0.4'
}
